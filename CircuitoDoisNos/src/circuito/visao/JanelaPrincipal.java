...
import circuito.controle.ValorInvalidoException;

/**
 * Janela principal da calculadora de circuito de dois nós (Problema 36).
 * Segue o modelo visual da imagem de referência (título, diagrama, variáveis
 * de entrada, ações e resultados), mas com o esquema elétrico correto do
 * problema: duas fontes (E1, E2) e três resistores (R1, R2, R3).
 */
public class JanelaPrincipal extends JFrame {

    private static final long serialVersionUID = 1L;

    private final CircuitoDoisNos circuito = new CircuitoDoisNos();
    ...
    private JLabel criarTitulo() {
        JLabel titulo = new JLabel("CALCULADORA DE CIRCUITO DE DOIS NÓS (PROBLEMA 36)", SwingConstants.CENTER);
