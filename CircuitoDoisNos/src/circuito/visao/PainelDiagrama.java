...
import circuito.controle.CircuitoDoisNos;

/**
 * Desenha o esquema elétrico do Problema 36 (Fig. 27.30): nó A no topo,
 * R2 e R3 horizontais ligando A às fontes E1 (esquerda) e E2 (direita), e
 * R1 vertical ligando A diretamente ao barramento de terra.
 *
 * Quando um cálculo já foi realizado, o painel também desenha setas
 * vermelhas indicando o sentido físico real da corrente em cada resistor.
 */
public class PainelDiagrama extends JPanel {
    ...
    private CircuitoDoisNos circuito;
    ...
    /** Atualiza os dados usados para desenhar as setas de corrente e redesenha o painel. */
    public void atualizar(CircuitoDoisNos circuito, boolean calculado) {
