...
/**
 * Painel com um rótulo, um slider e um campo de texto sincronizados entre si,
 * usado para capturar cada variável de entrada do circuito (E1, E2, R1, R2, R3).
 *
 * O slider aceita, deliberadamente, uma faixa mais ampla do que o intervalo
 * fisicamente válido definido em ValidadorEntrada — assim o usuário pode
 * digitar ou arrastar até um valor "proibido" e o aviso de valor inválido
 * aparece somente ao clicar em "Calcular", como pedido.
 */
